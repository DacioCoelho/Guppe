...
with open('C:/Users/Dácio/PycharmProjects/guppe/ips.py', 'r') as arquivo:   #R de READ -> leitura
...
with open('C:/Users/Dácio/PycharmProjects/guppe/ips_saida.py', 'w') as arquivo: # W de Write -> Escrita
