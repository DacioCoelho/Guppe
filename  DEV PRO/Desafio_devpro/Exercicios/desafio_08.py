...
comissões. O vendedor recebe $200 por semana mais 9 por cento de suas vendas brutas daquela semana.
 Por exemplo, um vendedor que teve vendas brutas de $3000 em uma semana recebe $200 mais 9 por cento
  de $3000, ou seja, um total de $470. Escreva um programa (usando um array de contadores) que
...
salarios = [200, 250, 320,454, 555,565, 544,547,589,635, 784, 986, 333, 413, 516, 680, 791, 877, 999, 1542, 5748, 1000, 2000, 3000]
